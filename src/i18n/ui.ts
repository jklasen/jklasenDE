...
export const ui = {
  de: {
    ...
    // Hero
    'hero.greeting': 'Herzlich Willkommen',
    'hero.name': 'Jens Klasen',
    ...
    'about.personal.values': 'Meine Leitwerte: Struktur, Weitsicht und Verantwortung',
    ...
    'forge.rammageddon.cta': 'Zur RAMmageddon-Sektion',
    ...
    'certs.subtitle': 'Validierte Expertise und Community-Engagement',
    'certs.strategic': 'Strategischer Fokus: KI & Modern Cloud',
    'certs.community': 'Community Engagement & Anerkennung',
    'certs.fundamental': 'Grundlegende Zertifizierungen',
    ...
    'impressum.dispute': 'Online-Streitbeilegung',
    'impressum.dispute.text':
      'Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit. Wir nehmen nicht an einem Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teil.',
    'impressum.liability.title': 'Haftung für Inhalte',
    'impressum.liability.text':
    ...
    'briefing.overview.hubLead': 'Die Marktthese hinter der RAMmageddon-Serie gibt es auch als visuelle Sektion.',
    'briefing.overview.hubCta': 'Zur RAMmageddon-Sektion',
  ...
  en: {
    ...
    'about.personal.values': 'My guiding values: Structure, Foresight, and Responsibility',
    ...
    'forge.rammageddon.cta': 'To the RAMmageddon section',
    'forge.rammageddon.body':
    ...
    'certs.subtitle': 'Validated expertise and community engagement',
    'certs.strategic': 'Strategic Focus: AI & Modern Cloud',
    'certs.community': 'Community Engagement & Recognition',
    'certs.fundamental': 'Fundamental Certifications',
    ...
    'impressum.dispute': 'Online Dispute Resolution',
    'impressum.dispute.text':
      'The European Commission provides a platform for online dispute resolution (OS). We do not participate in dispute resolution proceedings before a consumer arbitration board.',
    ...
    'briefing.overview.empty': 'No articles published yet.',
    'briefing.overview.hubLead': 'The market thesis behind the RAMmageddon series is also available as a visual section.',
    'briefing.overview.hubCta': 'To the RAMmageddon section',
    'briefing.article.readingTimeLabel': 'Reading time',
    'briefing.article.author.heading': 'About the author',
    'briefing.article.author.body':
      'Jens Klasen is Technology Evangelist at CID GmbH and writes about the shift from hardware to software in the infrastructure world. The Future Proof Tech Briefing appears irregularly here and on LinkedIn — when there\'s something to say.',
    'briefing.article.back': '← Back to the briefing overview',
    'briefing.teaser.eyebrow': 'Currently in the briefing',
    'briefing.teaser.cta.read': 'Read the article',
