...
The frame around all of this: the major manufacturers — Samsung, SK Hynix, Micron — openly warn that the situation remains tight through 2027 and beyond. Gartner and Counterpoint see the earliest turning point no earlier than Q4 2027. McKinsey forecasts seven trillion US dollars of data center investment through 2030, of which 5.2 trillion AI-driven. Memory accounts for around 30 percent of hyperscaler data center spending this year — four times as much as in 2023.
...
That rationality is dead. When the cost curve of memory shifts permanently upwards, so does the point at which software modernization pays off — fundamentally, in every TCO calculation. What was a "nice to have" in 2023 is the mathematically necessary answer in 2026.

From this, three shifts in IT doctrine follow:

**From procurement to architecture.** The central question is no longer "when do we order, at what price?", but "what load does this hardware actually need to carry in three years?". Anyone who doesn't answer the second question optimizes the first in vain.
...
1. **Treat memory as a scarce good, not a commodity.** Quote windows have shrunk to between one and 30 days; in some cases prices are only fixed at delivery. Procurement is no longer an ordering process, it is risk management with lead time. Anyone who doesn't map that organizationally pays the premium of the unprepared.

2. **Measure before you modernize.** Without a solid workload profile, every efficiency discussion is a matter of belief. Which VMs are zombies? Where do the IOPS hotspots sit? Which data models force RAM that modernization could halve? The map from Part 5 is the start — the measurement is the duty.

3. **Lower memory demand before you buy memory.** Every modernization that reduces the footprint is an investment with a double yield: once in hardware avoided at today's prices, once in hardware avoided at the prices of 2027.
...
Part 5 drew the map — seven use cases in which money evaporates in 2026. Part 6 has now formulated the doctrine for reading that map. The next deep dives go into the individual hotspots: data and workload modernization as an AI door-opener, and sovereign architecture as both transition and target state.
